...
#path = '/home/ec3731/checkpoints/barlowtwins/factorize_avgpool_equivariant_all_bn_injection_v1/stats.txt'
path = '/home/ec3731/checkpoints/barlowtwins/notexture/equivariant_all_bn_v5/stats.txt'
...
#plt.tight_layout()
plt.title('training curve faces no texture equivariant_all_bn_v5')
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/training_curves/notexture_equivariant_all_bn_v5.png')
