...
path = '/mnt/smb/locker/issa-locker/users/Eugénie/models/checkpoints/barlowtwins/backbone/equivariant_all_bn_v3_v2/stats.txt'
# -- 
...
#plt.tight_layout()
plt.title('training curve imagenet equivariant_all_bn_v3_v2 - backbone')
plt.show()
plt.savefig('/mnt/smb/locker/issa-locker/users/Eugénie/nn-analysis/training_curves/backbone_equivariant_all_bn_v3_v2.png')
